...
public class TestVinotecaStream {
	...
	public static void main(String[] args) {
		...
		// Caso de prueba para ver si se gestionan bien los parÃ¡metros
	...
	public static void testObtenerVinosRangoPuntos(Vinoteca vinos, Integer inf, Integer sup) {
		...
		try {
			...
			System.out.println("ExcepciÃ³n capturada: " + iae);
		} catch (Exception e) {
			System.out.println("ExcepciÃ³n inesperada capturada:\n   " + e);
		}
	}
	...
	public static void testCalcularNumeroVinosDePaisConPuntuacionSuperior (Vinoteca vinos, String pais, Integer umbralPuntuacion) {
		...
		try {
			System.out.println(String.format("\tHay %d  vinos del pais %s con puntuaciÃ³n superior a %d: ",
	...
	private static void testExisteVinoDeUvaEnRegion(Vinoteca vinos, String uva, String region) {
		...
		try {
			String msg = String.format("\tÂ¿Hay algÃºn vino de la uva %s en la regiÃ³n %s? %s",
	...
	public static void testCalcularUvasDeRegion(Vinoteca vinos, String region) {
		...
		try {
			...
			String msg = String.format("\tHay %d uvas de la regiÃ³n %s y son",
					uvas.size(), region );
			System.out.println(msg);
			uvas.stream()
	...
	private static void testCalcularTotalPuntosVinosDeRegion(Vinoteca vinos, String region) {
		...
		try {
			String msg = String.format("\tEl total de puntos de la regiÃ³n %s es %d",
	...
	private static void testObtenerNVinosRegionOrdenadosPrecio(Vinoteca vinos, String region, Integer n) {
		...
		try {
			String msg = String.format("\tLos %d vinos mÃ¡s caros de la regiÃ³n %s son", n, region);
			System.out.println(msg);
	...
	public static void testAgruparUvasPorPais(Vinoteca vinos) {
		...
		try {
			System.out.println("Las uvas de cada paÃ­s son: ");
	...
	public static void testCalcularVinoMasCaroPorPais(Vinoteca vinos) {
		...
		try {
			System.out.println(String.format("\tVino mÃ¡s caro por pais: " )
	...
	public static void testCalcularRegionConMejoresVinos(Vinoteca vinos, Double umbral) {
		...
		try {
			System.out.println(String.format("\tLa regiÃ³n con mejores vinos con una calidad-precio superior o igual a %.1f: \n", umbral)
